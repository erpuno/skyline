...
-include("../../../deps/nitro/include/nitro.hrl").
...
-record(htmlbox, {?CTRL_BASE(element_htmlbox), html, state=#upload_state{}, root, delegate_query, delegate_api, post_write, img_tool, post_target, size}).
-endif.
